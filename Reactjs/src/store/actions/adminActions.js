...
import {getAllCodeService, createNewUserService, getAllUsers, deletUserService, editUserService, 
    ...
    getAllClinic, getAllBookingPatient, getAllDetailClinicById} from "../../services/userService";
            ...
            export const fetchAllBooking = () => {
                return async (dispatch, getState) => {
                    try{
                        ...
                        let res = await  getAllBookingPatient()
                        if(res && res.errCode === 0){
                            dispatch({
                            ...
                            console.log('FETCH_ALL_BOOKING_FAILED',e)
                        dispatch({
                            type: actionTypes.FETCH_ALL_BOOKING_FAILED,
                            })   
                        }
                ...
                export const fetchAllDetailClinicById = () => {
                    return async (dispatch, getState) => {
                        try{
                            ...
                            if(res && res.errCode === 0){
                                dispatch({
                                    type: actionTypes. FETCH_ALL_DETAIL_CLINIC_BY_ID_SUCCESS,
                                    dataClinicById: res.data,
                                ...
                                dispatch({
                                type: actionTypes.FETCH_ALL_DETAIL_CLINIC_BY_ID_FAILED,
                                })   
